...
Fork this repository using the **Fork** option at the top-right corner of this page. This will create your own copy of this repository. You'll be redirected to your forked repository. Copy the link of this repository (which will look like `https://github.com/Real-Dev-Squad/website-goals`) as you'll need it in the step 2.
...
```
git remote add upstream https://github.com/Real-Dev-Squad/website-goals
```
